...
def read_const_pool_entry_kinds
...
def read_enum(name)
    ...
    input_files = ['dora-bytecode/src/data.rs', 'dora-runtime/src/boots/data.rs', 'dora-runtime/src/vm/known.rs']
...
def output
    ...
    const_pool_entry_kinds = read_const_pool_entry_kinds
    ...
    File.open('pkgs/boots/bytecode/opcode.dora', 'w') do |f|
        ...
        for kind in const_pool_entry_kinds
            f.puts "pub const CONST_POOL_ENTRY_KIND_#{snake_case(kind)}: Int32 = #{code};"
            code += 1
        end
