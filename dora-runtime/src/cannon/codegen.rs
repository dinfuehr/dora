...
use crate::vm::{
    ...
    get_concrete_tuple_bty, get_concrete_tuple_bty_array, specialize_ty_array_in_program,
...
impl<'a> CannonCodeGen<'a> {
    ...
    fn emit_intrinsic_unsafe_kill_refs(
        ...
        self.asm.array_address(
            REG_TMP1,
            REG_RESULT,
            REG_TMP1,
            size(self.vm(), bytecode_type),
        );
