...
use crate::error::diagnostics::{
    ...
    PACKAGE_AS_VALUE, PATTERN_BINDING_NOT_DEFINED_IN_ALL_ALTERNATIVES, PATTERN_BINDING_WRONG_TYPE,
    ...
    TYPES_INCOMPATIBLE, UN_OP_TYPE, UNEXPECTED_ARGUMENTS_FOR_ENUM_VARIANT,
    UNEXPECTED_NAMED_ARGUMENT, UNEXPECTED_POSITIONAL_ARGUMENT, UNKNOWN_ENUM_VARIANT, UNKNOWN_FIELD,
    UNKNOWN_IDENTIFIER, UNKNOWN_IDENTIFIER_IN_MODULE, UNKNOWN_METHOD,
    UNKNOWN_METHOD_FOR_TYPE_PARAM, UNKNOWN_STATIC_METHOD, UNKNOWN_STATIC_METHOD_WITH_TYPE_PARAM,
    USE_NOT_ACCESSIBLE, USE_OF_UNKNOWN_ARGUMENT, VALUE_EXPECTED,
    VARIADIC_PARAMETER_NEEDS_TO_BE_LAST, WHILE_COND_TYPE, WRONG_NUMBER_TYPE_PARAMS, WRONG_TYPE,
...
#[test]
fn test_super_module_path() {
    ok("
        fn bar(): Int32 { 42 }
        mod inner {
            pub fn f(): Int32 { super::bar() }
        }
    ");
}

#[test]
fn test_super_as_value() {
    err(
        "mod inner { fn f() { super; } }",
        (1, 22),
        5,
        crate::ErrorLevel::Error,
        &SUPER_AS_VALUE,
...
#[test]
fn test_super_no_parent_module() {
    err(
        "fn f() { super::bar(); }",
        (1, 10),
        5,
