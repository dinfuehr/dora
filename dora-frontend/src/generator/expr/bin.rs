...
pub(super) fn gen_intrinsic_bin(
    ...
    match intrinsic {
        ...
        Intrinsic::Int32CheckedAdd => g.builder.emit_add(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int32CheckedSub => g.builder.emit_sub(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int32CheckedMul => g.builder.emit_mul(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int32CheckedDiv => g.builder.emit_div(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int32CheckedMod => g.builder.emit_mod(dest, lhs_reg, rhs_reg, location),
        ...
        Intrinsic::Int64CheckedAdd => g.builder.emit_add(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int64CheckedSub => g.builder.emit_sub(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int64CheckedMul => g.builder.emit_mul(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int64CheckedDiv => g.builder.emit_div(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int64CheckedMod => g.builder.emit_mod(dest, lhs_reg, rhs_reg, location),
