...
pub(super) fn gen_intrinsic_bin(
    ...
    match intrinsic {
        ...
        Intrinsic::Int32CheckedAdd => g.builder.emit_checked_add(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int32CheckedSub => g.builder.emit_checked_sub(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int32CheckedMul => g.builder.emit_checked_mul(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int32CheckedDiv => g.builder.emit_checked_div(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int32CheckedMod => g.builder.emit_checked_mod(dest, lhs_reg, rhs_reg, location),
        ...
        Intrinsic::Int32Shl => g.builder.emit_shl(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int32Shr => g.builder.emit_shr(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int32Sar => g.builder.emit_sar(dest, lhs_reg, rhs_reg, location),

        Intrinsic::Int64CheckedAdd => g.builder.emit_checked_add(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int64CheckedSub => g.builder.emit_checked_sub(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int64CheckedMul => g.builder.emit_checked_mul(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int64CheckedDiv => g.builder.emit_checked_div(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int64CheckedMod => g.builder.emit_checked_mod(dest, lhs_reg, rhs_reg, location),
        ...
        Intrinsic::Int64Shl => g.builder.emit_shl(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int64Shr => g.builder.emit_shr(dest, lhs_reg, rhs_reg, location),
        Intrinsic::Int64Sar => g.builder.emit_sar(dest, lhs_reg, rhs_reg, location),

        Intrinsic::Float32Add => g.builder.emit_add(dest, lhs_reg, rhs_reg),
        Intrinsic::Float32Sub => g.builder.emit_sub(dest, lhs_reg, rhs_reg),
        Intrinsic::Float32Mul => g.builder.emit_mul(dest, lhs_reg, rhs_reg),
        Intrinsic::Float32Div => g.builder.emit_div(dest, lhs_reg, rhs_reg),

        Intrinsic::Float64Add => g.builder.emit_add(dest, lhs_reg, rhs_reg),
        Intrinsic::Float64Sub => g.builder.emit_sub(dest, lhs_reg, rhs_reg),
        Intrinsic::Float64Mul => g.builder.emit_mul(dest, lhs_reg, rhs_reg),
        Intrinsic::Float64Div => g.builder.emit_div(dest, lhs_reg, rhs_reg),
