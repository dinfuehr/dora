...
use crate::vm::{
    add_ref_fields, ensure_tuple, specialize_enum_id_params, specialize_struct_id_params,
    ClassDefinition, ClassDefinitionId, ClassInstance, ClassInstanceId, EnumDefinition,
    EnumInstance, EnumLayout, FieldDef, SemAnalysis, TraitDefinition, TraitDefinitionId, TupleId,
};
