use crate::language::sem_analysis::{
    ConstDefinitionId, GlobalDefinitionId, NamespaceId, StructDefinitionFieldId, StructDefinitionId,
};
use crate::vm::{
    ClassDefinitionId, EnumDefinitionId, FctDefinitionId, FctParent, FieldId, ModuleId,
