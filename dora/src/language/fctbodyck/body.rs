...
use crate::language::sem_analysis::{
    find_methods_in_struct, NamespaceId, StructDefinition, StructDefinitionId,
};
...
use crate::vm::{
    ...
    FctDefinitionId, FctParent, FileId, ForTypeInfo, IdentType, Intrinsic, SemAnalysis, TypeParam,
