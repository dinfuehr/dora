...
use crate::language::sem_analysis::{
    ClassDefinitionId, FctDefinitionId, Intrinsic, NamespaceId, StructDefinitionId,
};
...
use crate::stdlib;
use crate::vm::{
    AnnotationDefinitionId, EnumDefinitionId, ExtensionId, ModuleId, SemAnalysis, TraitDefinitionId,
};
