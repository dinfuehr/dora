...
use crate::language::sem_analysis::{
    AnnotationDefinitionId, ClassDefinitionId, EnumDefinitionId, FctDefinitionId, Intrinsic,
    NamespaceId, StructDefinitionId,
};
...
use crate::stack;
use crate::stdlib;
use crate::vm::{ExtensionId, SemAnalysis, TraitDefinitionId};
