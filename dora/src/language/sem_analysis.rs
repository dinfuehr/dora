...
use crate::vm::{
    extension_matches, impl_matches, Candidate, ClassDefinitionId, FctDefinition, FctDefinitionId,
    File, FileId, NamespaceId, SemAnalysis, TypeParam, TypeParamDefinition,
};
#[cfg(test)]
use crate::vm::{
