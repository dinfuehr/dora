...
fn encode_source_type(vm: &VM, ty: SourceType, buffer: &mut Vec<u8>) {
    ...
    match ty {
        ...
        SourceType::Unit => buffer.push(SourceTypeOpcode::Unit.to_int()),
        SourceType::Bool => buffer.push(SourceTypeOpcode::Bool.to_int()),
        SourceType::Char => buffer.push(SourceTypeOpcode::Char.to_int()),
        SourceType::UInt8 => buffer.push(SourceTypeOpcode::UInt8.to_int()),
        SourceType::Int32 => buffer.push(SourceTypeOpcode::Int32.to_int()),
        SourceType::Int64 => buffer.push(SourceTypeOpcode::Int64.to_int()),
        SourceType::Float32 => buffer.push(SourceTypeOpcode::Float32.to_int()),
        SourceType::Float64 => buffer.push(SourceTypeOpcode::Float64.to_int()),
