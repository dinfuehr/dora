...
impl BytecodeBuilder {
    ...
    pub fn add_const_enum(&mut self, id: EnumId, type_params: SourceTypeArray) -> ConstPoolIdx {
    ...
    pub fn add_const_struct(&mut self, id: StructId, type_params: SourceTypeArray) -> ConstPoolIdx {
        self.writer
    ...
    pub fn emit_mul_int32_unchecked(&mut self, dest: Register, lhs: Register, rhs: Register) {
        assert!(self.def(dest) && self.used(lhs) && self.used(rhs));
        self.writer.emit_mul_int32_unchecked(dest, lhs, rhs);
    }
    ...
    pub fn emit_mul_int64_unchecked(&mut self, dest: Register, lhs: Register, rhs: Register) {
        assert!(self.def(dest) && self.used(lhs) && self.used(rhs));
        self.writer.emit_mul_int64_unchecked(dest, lhs, rhs);
    }
    ...
    pub fn emit_sub_int32_unchecked(&mut self, dest: Register, lhs: Register, rhs: Register) {
        assert!(self.def(dest) && self.used(lhs) && self.used(rhs));
        self.writer.emit_sub_int32_unchecked(dest, lhs, rhs);
    }
    ...
    pub fn emit_sub_int64_unchecked(&mut self, dest: Register, lhs: Register, rhs: Register) {
        assert!(self.def(dest) && self.used(lhs) && self.used(rhs));
        self.writer.emit_sub_int64_unchecked(dest, lhs, rhs);
    }
