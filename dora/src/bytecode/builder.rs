...
impl BytecodeBuilder {
    ...
    pub fn generate_with_registers(self, registers: Vec<BytecodeType>) -> BytecodeFunction {
        self.writer.generate_with_registers(registers)
    }
}
